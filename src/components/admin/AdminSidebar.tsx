...
const navItems: { label: string; href: string; icon: LucideIcon; submenu?: { label: string; href: string }[] }[] = [
  ...
  },
  {
    ...
    submenu: [
      { label: "Nueva entrada", href: "/admin/blog/nuevo" },
...
export function AdminSidebar() {
  ...
  return (
    <aside className="w-64 bg-[#1A1A1A] h-screen flex flex-col shrink-0">
      {/* Logo */}
      <div className="px-6 py-5 border-b border-white/10">
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <p className="text-white/40 text-xs">Laura Álvarez Asesoría</p>
          </div>
        </div>
      </div>

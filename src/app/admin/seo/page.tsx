...
function SeoForm({ pageName, defaultValues }: { pageName: string; defaultValues: FormData }) {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-5 bg-white rounded-xl p-6 shadow-sm">
      <div>
        <Label className="text-[#0A1628] font-medium">Meta título</Label>
      ...
      <div>
        <Label className="text-[#0A1628] font-medium">Meta descripción</Label>
      ...
      <div>
        <Label className="text-[#0A1628] font-medium">Palabras clave</Label>
...
export default function SeoAdminPage() {
  ...
  return (
    <div className="max-w-2xl">
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-[#0A1628] font-[var(--font-heading)]">SEO</h1>
